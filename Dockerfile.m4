...
RUN mkdir --parents __INSTALL__ && \
    ...
    __INSTALL__/bin/keytool -keystore __INSTALL__/jre/lib/security/cacerts -importcert -alias letsencrypt_chain -file /usr/local/share/ca-certificates/chain.crt -storepass changeit -noprompt && \
